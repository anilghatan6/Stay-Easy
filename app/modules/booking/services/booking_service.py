...
from app.utils.refund_calculator import (
...
class BookingService:
    ...
    def _calculate_refund_amount(
        ...
        return calculate_refund_amount(booking, room_units)
    ...
    def _calculate_single_room_refund(
        ...
        return calculate_single_room_refund(
            cancellation_policy, hours_until_checkin, room_amount_paid
        )
